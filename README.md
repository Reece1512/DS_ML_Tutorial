...
│   ├── Project_03_Home_Prices_Prediction_Final.ipynb
│   ├── Project_03_Home_Prices_Prediction_Upgrade.ipynb
│   ├── Project_Data_Visualization - California_Cities.ipynb
│   ├── Project_Seaborn.ipynb
...
```bash
git clone https://github.com/Reece1512/DS_ML_Tutorial.git
cd DS_ML_Tutorial
```

**2. Install dependencies**
```bash
pip install numpy pandas matplotlib seaborn scikit-learn xgboost torch jupyter
```
